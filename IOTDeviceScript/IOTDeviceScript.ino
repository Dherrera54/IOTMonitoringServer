...
const char ssid[] = "Bilbo_Laggins"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "JYD6139146"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "54.236.60.100"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
 ...
 */
 void ledSwitch(String message)
 {
  if(message=="ALERT_MAX!"){
